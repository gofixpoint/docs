...
description: "Open-source plan and the capabilities Amika's daemon is evolving toward."
---
...
Amika aims to build semantic data views for agents, so workflows are organized by intent rather than source-system boundaries.
