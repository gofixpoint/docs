...
Amika is a Go CLI and HTTP server that materializes external data as files and mounts those files into Docker-backed sandboxes.
...
| `amika volume list/delete` | Manage tracked volumes |
...
| `bindfs` + macFUSE | Legacy v0 mount flow |
