...
<Tip>
You can also define setup scripts in [`.amika/config.toml`](/reference/repository-configuration#lifecycle-setup-and-start-scripts) so they apply automatically when creating sandboxes from a repository. The `--setup-script` flag always takes priority.
</Tip>
