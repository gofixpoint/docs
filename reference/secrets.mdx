...
| Delete | `DELETE /secrets/{id}` (see below) | `amika secret claude\|codex delete`, `deleteProviderSecret` |
...
- [Inject credentials](/guides/inject-credentials) — wire secrets into rigs
