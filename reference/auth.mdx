...
agent credentials into Amika's web UI or to seed rigs.
...
| `AMIKA_API_URL` | `https://app.amika.dev` | Override the remote API base URL. Used by rig commands when operating on remote rigs |
