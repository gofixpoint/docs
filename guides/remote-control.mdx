---
title: "Remote control agents and rigs"
description: "Connect to Amika rigs and interact with their coding agents."
---

Use Amika from the surface that fits the task. There are many ways to interact with a rig and its agents:

- Use the [web UI](https://app.amika.dev/)
- Use the [CLI](/reference/cli) to send messages to agents or run commands in rigs
...
- Connect to the rig with your favorite editor or ADE, such as the Codex app, Cursor, OpenCode Web, and other apps

## Work with agents

Send a prompt to an agent when you want Amika to provision a rig and run
...
<CardGroup cols={2}>
  ...
  <Card title="Use OpenCode" icon="code" href="/guides/opencode">
    Connect OpenCode to an Amika rig.
  </Card>
</CardGroup>
...
use a local development tool against the rig.

<CardGroup cols={2}>
  <Card title="SSH and connect" icon="terminal" href="/guides/ssh-and-connect">
    Open a shell in a rig from the CLI or SSH.
  </Card>
  <Card title="Open in an editor or ADE" icon="square-pen" href="/guides/open-in-editor">
    Open a rig in Cursor, VS Code, Claude Desktop, Codex, or another Remote-SSH editor.
  </Card>
</CardGroup>
