...
A rig is a VM tuned for coding agents. It is a shared workstation where agents
and people can work in the same repository and environment.
...
## Rig naming in developer interfaces

`rig` is the product term and the canonical CLI command:
