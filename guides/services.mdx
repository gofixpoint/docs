...
<Warning>
Container ports **60899–60999** are reserved for internal Amika services and are rejected in service declarations. See [Reserved ports](/guides/sandbox-configuration#reserved-ports) for details.
</Warning>
...
- [Sandbox configuration](/guides/sandbox-configuration) — lifecycle scripts, git cloning, reserved ports
- [CLI reference](/reference/cli-reference) — full command and flag index
- [HTTP API reference](/reference/http-api) — REST endpoints for sandboxes and services
