...
description: "Give isolated agents pre-authenticated access to external tools via MCP servers."
---

MCP (Model Context Protocol) integrations let an isolated coding agent call out to external services — error trackers, project management tools, internal systems — without running an interactive OAuth flow inside the rig.
