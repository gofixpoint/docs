...
With this set, `amikalyze` runs in its own rig on every PR,
...
<CardGroup>
  ...
  <Card title="Set up repository configuration for VM rigs" href="/guides/set-up-vm-repo-config" icon="wand-magic-sparkles" />
