...
- Run `amika sandbox create` **from inside a git repo** and that repo is used
...
- Pass `--no-git` to skip auto-detection and create a **repo-less sandbox** — a
  sandbox with no repository mounted. This is useful for scratch environments or
