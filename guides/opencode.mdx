---
title: "OpenCode"
description: "Manage the credentials that protect OpenCode web access on your rigs."
---

Rigs can serve OpenCode's web console so you can drive the agent from a
...
so every teammate's rigs use the same login.
...
<Note>
Changes apply to new rigs and to rigs that restart. Running rigs
...
<Warning>
With password authentication disabled, anyone with the rig URL can access
...
pill returns to **Using defaults**, and rigs fall back to the platform's
