...
- A Claude API key on disk. See
  [Agent authentication](/guides/agent-authentication) for how to push it to
...
[Pin a credential at sandbox creation](/guides/agent-authentication#pin-a-credential-at-sandbox-creation).
</Info>
...
<CardGroup cols={2}>
  <Card title="Agent authentication" icon="key-round" href="/guides/agent-authentication">
