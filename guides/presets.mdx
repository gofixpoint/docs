...
Preset images reserve container ports **60899–60999** for Amika internal services (e.g. OpenCode web on 60998, amikad daemon on 60999). See [Sandbox configuration](/guides/sandbox-configuration#reserved-ports) for the full allocation table.
...
This gives agents credentials inside the sandbox without modifying host source files. See [Sandbox configuration](/guides/sandbox-configuration#agent-credential-auto-mounting) for the full list of supported files.
