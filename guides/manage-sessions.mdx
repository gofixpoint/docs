...
description: "Create, list, fetch, and update agent sessions in a rig."
---

Each rig tracks a set of agent sessions. The full session CRUD surface is
...
amika rig agent-send dev-box "Plan the migration" --new-session

# Resume a specific session
amika rig agent-send dev-box "Continue from earlier" \
  --session-id 3f2a...
```
