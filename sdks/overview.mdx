...
rigs from a program rather than the shell.

## Available SDKs

<CardGroup cols={2}>
  <Card title="TypeScript" icon="js" href="/sdks/typescript/quickstart">
    `@amika/sdk` — rigs, sessions, secrets, agent invocations.
  </Card>
...
| Use case | Tool |
| --- | --- |
| Day-to-day shell work, ad-hoc rig creation | CLI |
...
| CI: spin up a rig per PR | SDK (or CLI in a job that has `AMIKA_API_KEY` set) |
